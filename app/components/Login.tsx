    ...
    <div>
      <div className="relative block lg:hidden">
        <div className="bg-[#B188E3] relative w-full h-90 rounded-b-full flex justify-center items-center">
          <h1 className="font-bold text-6xl text-[#553922]">Log In</h1>
        </div>
        <Image
          src={young_man}
          alt="young man"
      ...
      <div className="flex gap-40 justify-center lg:items-center ">
        ...
        <div className="flex flex-col justify-center items-center w-full lg:w-1/3  h-screen ">
          ...
          <div className="hidden lg:block">
            ...
            <h1 className="text-4xl font-bold">
              <span>Welcome</span>
              <span className="text-[#B188E3]"> Back!</span>
            </h1>
          </div>
          <form action="" className=" w-full">
            <div className="px-10 ">
              ...
              <span className="text-gray-500 font-bold flex justify-end py-2">Forgot Password?</span>
            </div>
        ...
        <div className="hidden lg:block h-screen relative ">
          <Image
            src={young_man}
            alt="young man"
            className="relative z-10 top-40 right-20 w-80"
          />
