        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="mb-10 pt-16 w-full  lg:mb-0 lg:max-w-xl font-poppins space-x-6">
            ...
            <p className="mb-8 text-lg text-gray-600">
              Verified school profiles, real parent reviews, and direct
              connections—all in one place.
            </p>

            <Link
              href={"/login"}
              className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#3F3D56] to-[#B188E3] hover:from-[#B188E3] hover:to-[#3F3D56] text-white font-bold py-3  rounded-lg w-40"
            >
              <span className="">
                <PiCompass size={20} />
              </span>
